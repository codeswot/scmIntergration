...
class ScanOutboundItemsScreenScreen extends StatefulWidget {
  final dynamic locationID;

  const ScanOutboundItemsScreenScreen({Key key, this.locationID})
      : super(key: key);
  @override
  _ScanOutboundItemsScreenScreenState createState() =>
      _ScanOutboundItemsScreenScreenState(locationID);
}
...
class _ScanOutboundItemsScreenScreenState
    extends State<ScanOutboundItemsScreenScreen> {
  var qrText = "";
  ...
  _ScanOutboundItemsScreenScreenState(this.locationID);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Outbound - Scan Items in Ticket'),
      ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text('Scan Items in Ticket',
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: Text(
                    "Scan the items one after the other to verify they match the items in the ticket",
                ...
                child: ExpansionTile(
                  title: Container(
                    child: Row(
                      ...
                      children: <Widget>[
                        Text(
                            '${poList.length}  of ${poList.length} items scanned for pickup',
                            style: TextStyle(
