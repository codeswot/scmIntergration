...
import 'package:inventory_app/screens/remove-goods/RemovalSuccessScreen.dart';
...
class RemoveItemsScanner extends StatefulWidget {
  @override
  _RemoveItemsScannerState createState() => _RemoveItemsScannerState();
}
...
class _RemoveItemsScannerState extends State<RemoveItemsScanner> {
  var qrText = "";
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text('Scan Items out of Warehouse',
              ...
              child: SizedBox(
                ...
                child: Text(
                    "Scan the items one after the other to verifiy " +
                        "they match the items in the R.ID",
...
//                                _controller.pauseCamera();
                                Navigator.of(context)
                                    .pushReplacement(MaterialPageRoute(builder: (_) => RemovalSuccessScreen()));
                              },
                          ...
                          dialogBody: <TextSpan>[
                            ...
                            TextSpan(
                              text: ' ${poList.length} out of ${poList.length}',
                              style: TextStyle(fontWeight: FontWeight.w700),
                            ),
                            TextSpan(text: ' items from the Removal ID.'),
                            TextSpan(
